...
<table width="865" border="0" align="center" id="logtb1" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="319" rowspan="2"><form name="form1" method="post" action="${pageContext.request.contextPath }/dologin.jsp">
      <table width="340" border="1" style="border-color:#3FF" align="right" cellpadding="0" cellspacing="0">
        <tr>
          <td height="50" colspan="2" align="center"><label for="userName"></label>
            <input name="userName" type="text" class="log_input" id="userName" value="<%=userName%>"></td>
        </tr>
        <tr>
          <td height="50" colspan="2" align="center"><input name="userPass" type="password" class="log_input" id="userPass"></td>
        </tr>
        <tr>
          <td height="50" colspan="2" align="center"><label for="textfield7"></label>
            <input type="text" name="textfield3" id="textfield7" class="log_input" value="<%=request.getAttribute("message")==null?"":request.getAttribute("message") %> ">
...
下次自动登录</td>
        ...
        <tr>
          <td height="50" colspan="2" align="center"><input type="image" id="imageField" src="images/btn-login.png"></td>
        </tr>
        <tr>
          <td height="50" colspan="2" align="center"><a href="register.jsp">注册</a></td>
        </tr>
      </table>
    </form>
    </td>
